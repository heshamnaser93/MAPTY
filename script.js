...
class App {
  ...
  _newWorkout(e) {
    ...
    //Check Validity small helper function
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp));

    //Check positivity small helper function
  ...
  _renderWorkoutMarker(wk) {
    L.marker(wk.coords, {})
      ...
      .setPopupContent(
        `${wk.type === 'running' ? '🏃‍♂️' : '🚴‍♀️'}${wk.description}`
      )
      .openPopup();
  }
  ...
  _renderWorkout(wk) {
    ...
    if (wk.type === 'running') {
      html += `
          ...
          <div class="workout__details">
            <span class="workout__icon">🦶🏼</span>
            <span class="workout__value">${wk.cadence}</span>
    ...
    if (wk.type === 'cycling') {
      html += `
          <div class="workout__details">
            <span class="workout__icon">⚡️</span>
            <span class="workout__value">${wk.elevationGain}</span>
            <span class="workout__unit">min/km</span>
          </div>
          <div class="workout__details">
            <span class="workout__icon">⛰</span>
            <span class="workout__value">${wk.speed.toFixed(1)}</span>
            <span class="workout__unit">spm</span>
          </div>
        <li>`;
    }
